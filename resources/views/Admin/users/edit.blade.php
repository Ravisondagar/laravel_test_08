				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<form method="POST" action="{!! route('users.update',$user->id) !!}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Johnny Brown" name="name" value="{!! $user->name !!}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" placeholder="" type="text" name="middle_name" value="{!! $user->middle_name !!}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" value="" type="email" name="email" value="{!! $user->email !!}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" value="" type="password" name="password" value="{{ $user->password }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" value="" type="password" name="password_confirmation" value="{{ $user->password_confirmation }}">
						...
						<div class="form-group row">
							...
							<div class="custom-control custom-radio mb-5 ml-3" >
								<input type="radio" id="customRadio1" name="gender" class="custom-control-input" value="male" @if($user->user_profile->gender == 'male') checked @endif>
								<label class="custom-control-label" for="customRadio1">Male</label>
							</div>
							<div class="custom-control custom-radio mb-5 ml-3">
								<input type="radio" id="customRadio2" name="gender" class="custom-control-input" value="female" @if($user->user_profile->gender == 'female') checked @endif>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="" name="phone" value="{{ $user->user_profile ? $user->user_profile->phone : '' }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="" name="mobile" value="{{ $user->user_profile ? $user->user_profile->mobile : '' }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<textarea name="hobby" class="form-control">{{ $user->user_profile ? $user->user_profile->hobby : '' }}</textarea>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<textarea name="address_1" class="form-control">{{ $user->user_profile ? $user->user_profile->address_1 : '' }}</textarea>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<textarea name="address_2" class="form-control">{{ $user->user_profile ? $user->user_profile->address_2 : '' }}</textarea>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" name="city" value="{{ $user->user_profile ? $user->user_profile->city : '' }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" name="state" value="{{ $user->user_profile ? $user->user_profile->state : '' }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" name="country" value="{{ $user->user_profile ? $user->user_profile->country : '' }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="" name="zipcode" value="{{ $user->user_profile ? $user->user_profile->zipcode : '' }}">
						...
						<div class="form-group row">
							...
							<div class="custom-control custom-radio mb-5 ml-3" >
								<input type="radio" name="marital_status" class="custom-control-input" value="single" @if($user->user_profile->marital_status == 'single') checked @endif>
								<label class="custom-control-label" for="customRadio1">Male</label>
							</div>
							<div class="custom-control custom-radio mb-5 ml-3">
								<input type="radio" name="marital_status" class="custom-control-input" value="married" @if($user->user_profile->marital_status == 'married') checked @endif>
								<label class="custom-control-label" for="customRadio2">Female</label>
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="" name="pan_number" value="{{ $user->user_profile ? $user->user_profile->pan_number : '' }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="" name="management_level" value="{{ $user->user_profile ? $user->user_profile->management_level : '' }}">
						...
						{{-- <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="file" placeholder="" name="attach" value="{{ $user->user_profile->attach') }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="link" placeholder="" name="google" value="{{ $user->user_profile ? $user->user_profile->google : '' }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="link" placeholder="" name="facebook" value="{{ $user->user_profile ? $user->user_profile->facebook : '' }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="link" placeholder="" name="website" value="{{ $user->user_profile ? $user->user_profile->website : '' }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="link" placeholder="" name="skype" value="{{ $user->user_profile ? $user->user_profile->skype : '' }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="link" placeholder="" name="linkedin" value="{{ $user->user_profile ? $user->user_profile->linkedin : '' }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="link" placeholder="" name="twitter" value="{{ $user->user_profile ? $user->user_profile->twitter : '' }}">
