						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="{!! route('tasks.task-logs.index',$id) !!}">Task Logs</a></li>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						...
						<div class="pull-right">
							<a href="{!! route('tasks.task-logs.index',$id) !!}" data-toggle="tooltip" title="Back to task logs" class="btn btn-sm btn-primary btn-sm" rel="content-y"  role="button"><i class="fa fa-arrow-left"></i>Back</a>
						</div>
					</div><br>
					<form method="post" action="{!! route('tasks.task-logs.store',$id) !!}">
						@csrf
